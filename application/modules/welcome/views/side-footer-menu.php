                            ...
                            <div class="row align-items-center">
                                <div class="col-md-9 col-sm-18">
                                    <div class="footer-text">
                                        Copyright © <a href="en.html">FleetCart</a> 2020. All rights reserved.
                                    </div>
                                </div>
                                <div class="col-md-9 col-sm-18">
                                    <div class="footer-payment">
                                        <img src="<?php echo base_url();?>assets/images/r28gsyypi1oT531dU1MY1EjSskTWQbRIm7OHyTCl.webp" alt="accepted payment methods">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-content custom-scrollbar">
                        <div id="main-menu" class="tab-pane active">
                            <ul class="list-inline sidebar-menu">
                                ...
                                <li class="">
                                    <a href="https://codecanyon.net/item/fleetcart-laravel-ecommerce-system/23014826" class="menu-item" target="_blank">                
                                        BUY THEME!
                                    </a>
                                </li>    
                            </ul>
